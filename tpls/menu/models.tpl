<div id="menuModel" class="menu-models" data-models_action="toggle">
    ...
    <div class="menu_items">
        {menu_model:}<input class="menu_model_cb" id="model{_key:}" type="checkbox" data-model_id="{_key:}" data-models_action="show"{if:(show:=1)} checked{:fi}><label for="model{_key:}" class="menu_model-{_key:}" data-model_name="{name:}" title="Показать статьи для {name:}"></label>{:menu_model}
